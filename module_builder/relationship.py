class Relationship:
    ...
    def add_comp(self):
        self.name += "s"
        self.my_class_builder.new_class.all_my_composite_classes.append(self.name)

    def add_assos(self):
        self.my_class_builder.new_class.all_my_associated_classes.append(self.name)

    def add_extends(self):
        self.my_class_builder.new_class.all_my_parent_classes.append(self.name)
