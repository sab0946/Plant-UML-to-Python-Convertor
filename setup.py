...
setup(
    ...
    packages=['venv.Lib.site-packages.idna', 'venv.Lib.site-packages.certifi', 'venv.Lib.site-packages.chardet',
              ...
              'venv.Lib.site-packages.urllib3.packages.ssl_match_hostname', 'venv.Lib.site-packages.docutils',
              ...
              'venv.Lib.site-packages.docutils.transforms', 'venv.Lib.site-packages.graphviz',
              'venv.Lib.site-packages.httplib2', 'venv.Lib.site-packages.plantweb', 'venv.Lib.site-packages.requests',
              'venv.Lib.site-packages.sqlite3database', 'venv.Lib.site-packages.sqlite3database.helper',
              ...
              'venv.Lib.site-packages.pip-10.0.1-py3.7.egg.pip._internal.operations', 'Interpreter.unit_tests',
              'Interpreter.module_builder'],
    url='',
    license='',
    author='sarah_ball',
    author_email='sarahball1984@gmail.com',
    description=''
)
